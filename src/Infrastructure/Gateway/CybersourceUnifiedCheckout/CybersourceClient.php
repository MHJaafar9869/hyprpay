 ...
 * the decoded JSON, raw body, or HttpResponse. Non-2xx responses are converted
 * into a GatewayRequestException carrying the caller-supplied context label.
 */
final readonly class CybersourceClient
{
     ...
     */
    private function dispatch(string $method, string $path, ?string $payload, ?string $idempotencyKey = null): HttpResponse
    {
