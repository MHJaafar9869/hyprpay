...
final class CaptureContextPayload
{
     ...
     * and the order amount and optional billing address.
     *
     * @param  CheckoutSessionRequest  $request  Checkout session inputs (amount, allowed networks/types, origins, locale/country, optional billTo).
